...
public class JIRAHelper {
	...
	private static final String JIRA_URL = "jira server address";
	private static final String JIRA_ADMIN_USERNAME = "serviceaccount"; // "";
	private static final String JIRA_ADMIN_PASSWORD = "passwordforJIRA";
