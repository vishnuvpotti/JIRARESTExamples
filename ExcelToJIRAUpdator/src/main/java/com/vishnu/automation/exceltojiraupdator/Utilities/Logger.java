package com.vishnu.automation.exceltojiraupdator.Utilities;
...
public class Logger {
	...
	public static final String logFilename = "ExcelDataUploaderLog_" + currentTime + ".txt";
	...
	public static String GetCurrentPath() {
		...
		try {
			...
			System.out.println("GetCurrentPath: Current Location is :" + location.getPath());
