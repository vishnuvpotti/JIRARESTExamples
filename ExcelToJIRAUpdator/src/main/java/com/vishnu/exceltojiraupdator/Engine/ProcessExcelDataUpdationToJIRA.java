package com.vishnu.exceltojiraupdator.Engine;
...
import com.vishnu.exceltojiraupdator.Core.ProcessDataUpdation;
		...
		if (args.length == 1 && args[0].equalsIgnoreCase("/?")) {
			System.out.println(
					"Example usage : java -jar exceltojiraupdator.jar [excelpath] [-fields:fieldname1#jiraIDofFieldname1,fieldname2#jiraIDofFieldname2]\n"
							+ "eg - java -jar exceltojiraupdator.jar \"H:\\testdata\" \"Test Field\"#custom_100909,TestField2#custom_10933");
